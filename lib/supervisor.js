...
function help () {
  print
    ...
    ("")
    ("Example:")
    ("  supervisor -w . -p myapp.js")
    ("")
    ("Options:")
    ("  -w|--watch <watchItems>")
    ("    (Required) A comma delimited list of folders or js files to watch for changes.")
    ("    When a change to a js file occurs, reload the program")
    ("")
    ("  -p|--program <program>")
    ("    (Required) The program to run.")
    ("")
    ("  -e|--extensions <extensions>")
    ("    (Optional) Specific file extensions to watch in addition to defaults")
    ("    Used when --watch option includes folders")
    ("    Default is 'node|js'")
    ("")
    ("  -x|--exec <executable>")
    ("    (Optional) The executable that runs the specified program.")
    ("    Default is 'node'")
    ("")
    ("  -h|--help|-?")
